...
<div id="output-playlist-path">
    <div class="content-box-header">
        <div class="panel-title">Ссылка на обработанный плейлист</div>
    </div>
    <div class="content-box-large box-with-header" id="output-playlist-path-field"></div>
</div>
<div id="output-tvprogram-path">
    <div class="content-box-header">
        <div class="panel-title">Ссылка на обработанную телепрограмму</div>
    </div>
    <div class="content-box-large box-with-header" id="output-tvprogram-path-field"></div>
</div>
